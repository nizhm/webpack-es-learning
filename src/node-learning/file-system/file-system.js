...
const getOptions = function () {
  ...
  items.forEach((item,index) => {
    if(item.short) {
      let option = {}
      option.code = Number(item.tel)
      option.cn = item.name
      option.en = item.en
      option.acronym = item.short
